...
echo "## NTDEV INSTALL WINDOWS10 ##"

#isocheaker
read -p "Does NT_WIN10.iso File In Your Download Folder?(Yes/No) : " input
if [[ $input == Yes || $input == yes || $input == y || $input == Y ]]; then
   ...
   qemu-system-x86_64 -m $ram -cdrom /storage/emulated/0/NT​WINDOWSFORME/NT_WIN10.iso -vnc 127.0.0.1:2

elif [[ $input == No || $input == no || $input == n || $input == N ]]; then
echo -e "\e[1;91m1. First Download NT_WIN10.iso file from this Link: \e[1;92mhttp://bit.ly/nt_wintermux" #pastedownload link here
echo "2. Put NT_WIN10.iso file into download folder."
exit 2
else
